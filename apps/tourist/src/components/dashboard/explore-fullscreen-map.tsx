...
export function ExploreFullscreenMap({
  ...
  const REGION_CENTERS: Record<string, { center: [number, number]; zoom: number }> = {
    "comayagua":         { center: [-87.637, 14.456], zoom: 10 },
    "copan":             { center: [-89.14,  14.84],  zoom: 10 },
    "bay-islands":       { center: [-86.55,  16.3],   zoom: 10 },
    "islas-de-la-bahia": { center: [-86.55,  16.3],   zoom: 10 },
    "tegucigalpa":       { center: [-87.192, 14.072], zoom: 10 },
    "francisco-morazan": { center: [-87.192, 14.072], zoom: 10 },
    "cortes":            { center: [-88.024, 15.506], zoom: 10 },
    "la-ceiba":          { center: [-86.793, 15.781], zoom: 10 },
    "atlantida":         { center: [-86.793, 15.781], zoom: 10 },
    "olancho":           { center: [-85.76,  14.87],  zoom: 10 },
    "santa-barbara":     { center: [-88.234, 14.917], zoom: 11 },
    "choluteca":         { center: [-87.196, 13.3],   zoom: 11 },
    "lempira":           { center: [-88.567, 14.467], zoom: 11 },
    "intibuca":          { center: [-88.166, 14.316], zoom: 11 },
    "ocotepeque":        { center: [-89.183, 14.433], zoom: 11 },
    "yoro":              { center: [-87.133, 15.133], zoom: 11 },
    "el-paraiso":        { center: [-86.583, 13.867], zoom: 11 },
    "colon":             { center: [-85.9,   15.9],   zoom: 10 },
  };
